...
class Produto(models.Model):
    ...
    imagem = models.ImageField(
        upload_to='produto_imagens/%Y/%m/', blank=True, null=True, verbose_name='Imagem')
    ...
    get_preco_formatado.short_description = 'Preço Marketing'

    def get_preco_promocao_formatado(self):
        return utils.formata_preco(self.preco_marketing_promocional)
    get_preco_promocao_formatado.short_description = 'Preço Promocional'
